...
class FPSCONTROLLER_API UFirstPersonAnimInstance : public UAnimInstance, public IFPSAnimationInstance {
    GENERATED_BODY()
public:
    ...
    UAnimSequence* GetGripPose(UFPSGripData* GripData, TSubclassOf<AFPSRangedWeapon> WeaponClass);
