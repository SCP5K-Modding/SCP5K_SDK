...
void EmptyLinkFunctionForGeneratedCodeAIHordes_init() {}
	...
	UPackage* Z_Construct_UPackage__Script_AIHordes()
	{
		...
		if (!ReturnPackage)
		{
			static UObject* (*const SingletonFuncArray[])() = {
				(UObject* (*)())Z_Construct_UDelegateFunction_AIHordes_HordeAgentDelegate__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_AIHordes_HordeDelegate__DelegateSignature,
			};
