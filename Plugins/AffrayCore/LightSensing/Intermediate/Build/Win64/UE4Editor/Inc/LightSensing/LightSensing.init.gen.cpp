...
void EmptyLinkFunctionForGeneratedCodeLightSensing_init() {}
	...
	UPackage* Z_Construct_UPackage__Script_LightSensing()
	{
		...
		if (!ReturnPackage)
		{
			static UObject* (*const SingletonFuncArray[])() = {
				(UObject* (*)())Z_Construct_UDelegateFunction_LightSensing_LightHandleUpdatedDelegate__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_LightSensing_LightHandleUpdatedEvent__DelegateSignature,
			};
