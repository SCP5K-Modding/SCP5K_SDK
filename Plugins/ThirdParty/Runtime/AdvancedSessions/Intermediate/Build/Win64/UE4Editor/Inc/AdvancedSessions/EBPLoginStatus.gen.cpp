...
#include "AdvancedSessions/Public/EBPLoginStatus.h"
#ifdef _MSC_VER
#pragma warning (push)
#pragma warning (disable : 4883)
#endif
PRAGMA_DISABLE_DEPRECATION_WARNINGS
void EmptyLinkFunctionForGeneratedCodeEBPLoginStatus() {}
...
// End Cross Module References
	...
	uint32 Get_Z_Construct_UEnum_AdvancedSessions_EBPLoginStatus_Hash() { return 2391351857U; }
	UEnum* Z_Construct_UEnum_AdvancedSessions_EBPLoginStatus()
	{
		...
		if (!ReturnEnum)
		{
			...
			const UE4CodeGen_Private::FMetaDataPairParam Enum_MetaDataParams[] = {
				...
				{ "ModuleRelativePath", "Public/EBPLoginStatus.h" },
