...
// End Cross Module References
	DEFINE_FUNCTION(USteamCoreUserStatsAsyncActionGetNumberOfCurrentPlayers::execGetNumberOfCurrentPlayersAsync)
	{
		...
		P_FINISH;
		P_NATIVE_BEGIN;
		*(USteamCoreUserStatsAsyncActionGetNumberOfCurrentPlayers**)Z_Param__Result=USteamCoreUserStatsAsyncActionGetNumberOfCurrentPlayers::GetNumberOfCurrentPlayersAsync(Z_Param_WorldContextObject);
		P_NATIVE_END;
	}
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_USteamCoreUserStatsAsyncActionGetNumberOfCurrentPlayers_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_USteamCoreUserStatsAsyncActionGetNumberOfCurrentPlayers_GetNumberOfCurrentPlayersAsync, "GetNumberOfCurrentPlayersAsync" }, // 2030530266
	...
	IMPLEMENT_CLASS(USteamCoreUserStatsAsyncActionGetNumberOfCurrentPlayers, 530285864);
