...
// End Cross Module References
	...
	DEFINE_FUNCTION(USteamCoreUGCAsyncActionRemoveItemFromFavorites::execRemoveItemFromFavoritesAsync)
	{
		...
		P_FINISH;
		P_NATIVE_BEGIN;
		*(USteamCoreUGCAsyncActionRemoveItemFromFavorites**)Z_Param__Result=USteamCoreUGCAsyncActionRemoveItemFromFavorites::RemoveItemFromFavoritesAsync(Z_Param_WorldContextObject,Z_Param_AppID,Z_Param_PublishedFileID);
		P_NATIVE_END;
	}
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_USteamCoreUGCAsyncActionRemoveItemFromFavorites_Statics::FuncInfo[] = {
		...
		{ &Z_Construct_UFunction_USteamCoreUGCAsyncActionRemoveItemFromFavorites_RemoveItemFromFavoritesAsync, "RemoveItemFromFavoritesAsync" }, // 427580706
	};
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(USteamCoreUGCAsyncActionRemoveItemFromFavorites, 1398007481);
