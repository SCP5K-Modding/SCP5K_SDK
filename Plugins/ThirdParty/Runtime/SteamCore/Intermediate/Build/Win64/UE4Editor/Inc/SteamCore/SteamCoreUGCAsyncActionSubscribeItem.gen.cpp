...
// End Cross Module References
	...
	DEFINE_FUNCTION(USteamCoreUGCAsyncActionSubscribeItem::execSubscribeItemAsync)
	{
		...
		P_FINISH;
		P_NATIVE_BEGIN;
		*(USteamCoreUGCAsyncActionSubscribeItem**)Z_Param__Result=USteamCoreUGCAsyncActionSubscribeItem::SubscribeItemAsync(Z_Param_WorldContextObject,Z_Param_PublishedFileIDs);
		P_NATIVE_END;
	}
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_USteamCoreUGCAsyncActionSubscribeItem_Statics::FuncInfo[] = {
		...
		{ &Z_Construct_UFunction_USteamCoreUGCAsyncActionSubscribeItem_SubscribeItemAsync, "SubscribeItemAsync" }, // 438401124
	};
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(USteamCoreUGCAsyncActionSubscribeItem, 2037637015);
