...
void EmptyLinkFunctionForGeneratedCodeSteamCore_init() {}
	...
	STEAMCORE_API UFunction* Z_Construct_UDelegateFunction_SteamCore_OnAddAppDependencyResultAsyncDelegate__DelegateSignature();
	...
	STEAMCORE_API UFunction* Z_Construct_UDelegateFunction_SteamCore_OnDownloadItem__DelegateSignature();
	STEAMCORE_API UFunction* Z_Construct_UDelegateFunction_SteamCore_OnDownloadItemResult__DelegateSignature();
	STEAMCORE_API UFunction* Z_Construct_UDelegateFunction_SteamCore_OnDownloadItemResultDelegate__DelegateSignature();
	...
	STEAMCORE_API UFunction* Z_Construct_UDelegateFunction_SteamCore_OnRequestFriendRichPresence__DelegateSignature();
	...
	STEAMCORE_API UFunction* Z_Construct_UDelegateFunction_SteamCore_OnSendQueryUGCRequestAsyncDelegate__DelegateSignature();
	...
	STEAMCORE_API UFunction* Z_Construct_UDelegateFunction_SteamCore_OnStartPlaytimeTrackingAsyncDelegate__DelegateSignature();
	...
	UPackage* Z_Construct_UPackage__Script_SteamCore()
	{
		...
		if (!ReturnPackage)
		{
			static UObject* (*const SingletonFuncArray[])() = {
				(UObject* (*)())Z_Construct_UDelegateFunction_SteamCore_OnSteamAppInstalled__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_SteamCore_OnSteamAppUninstalled__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_SteamCore_OnDLCInstalled__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_SteamCore_OnFileDetailsResult__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_SteamCore_OnFileDetailsResultDelegate__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_SteamCore_EndGameResultDelegate__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_SteamCore_FindSteamSessionsResultDelegate__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_SteamCore_OnAvatarImageLoaded__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_SteamCore_OnClanOfficerListResponse__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_SteamCore_OnDownloadClanActivityCounts__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_SteamCore_OnDownloadClanActivityCountsResult__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_SteamCore_OnEnumerateFollowingList__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_SteamCore_OnFriendRichPresenceUpdate__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_SteamCore_OnGameConnectedChatJoin__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_SteamCore_OnGameConnectedChatLeave__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_SteamCore_OnGameConnectedClanChatMsg__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_SteamCore_OnGameConnectedFriendChatMsg__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_SteamCore_OnGameLobbyJoinRequested__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_SteamCore_OnGameOverlayActivated__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_SteamCore_OnGameRichPresenceJoinRequested__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_SteamCore_OnGameServerChangeRequested__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_SteamCore_OnGetFollowerCount__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_SteamCore_OnIsFollowing__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_SteamCore_OnJoinClanChatRoomCompletionResult__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_SteamCore_OnJoinClanChatRoom__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_SteamCore_OnPersonaStateChange__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_SteamCore_OnRequestClanOfficerList__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_SteamCore_OnSetPersonaName__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_SteamCore_OnSetPersonaNameResponse__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_SteamCore_OnGSStatsUnloaded__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_SteamCore_OnServerRequestUserStats__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_SteamCore_OnServerStoreUserStats__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_SteamCore_OnRequestEligiblePromoItemDefinitionsIDs__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_SteamCore_OnSteamInventoryDefinitionUpdate__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_SteamCore_OnSteamInventoryEligiblePromoItemDefIDs__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_SteamCore_OnSteamInventoryFullUpdate__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_SteamCore_OnSteamInventoryRequestPricesResult__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_SteamCore_OnSteamInventoryRequestPricesResultDelegate__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_SteamCore_OnSteamInventoryResultReady__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_SteamCore_OnSteamInventoryStartPurchaseResult__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_SteamCore_OnSteamInventoryStartPurchaseResultDelegate__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_SteamCore_OnCreateLobby__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_SteamCore_OnFavoritesListAccountsUpdated__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_SteamCore_OnFavoritesListChanged__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_SteamCore_OnJoinLobby__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_SteamCore_OnLobbyChatMsg__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_SteamCore_OnLobbyChatUpdate__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_SteamCore_OnLobbyDataUpdate__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_SteamCore_OnLobbyEnter__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_SteamCore_OnLobbyGameCreated__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_SteamCore_OnLobbyInvite__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_SteamCore_OnLobbyKicked__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_SteamCore_OnRequestLobbyList__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_SteamCore_OnServerPing__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_SteamCore_OnServerRules__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_SteamCore_OnServerUpdated__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_SteamCore_OnPlaybackStatusHasChanged__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_SteamCore_OnVolumeHasChanged__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_SteamCore_OnP2PSessionConnectFail__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_SteamCore_OnP2PSessionRequest__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_SteamCore_OnActiveBeaconsDelegate__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_SteamCore_OnAddAppDependencyResultAsyncDelegate__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_SteamCore_OnAddAppDependencyResult__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_SteamCore_OnAddItemToFavoritesAsyncDelegate__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_SteamCore_OnAddItemToFavorites__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_SteamCore_OnAddUGCDependencyResultAsyncDelegate__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_SteamCore_OnAddUGCDependencyResult__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_SteamCore_OnAssociateWithClan__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_SteamCore_OnAttachLeaderboardUGCAsyncDelegate__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_SteamCore_OnAttachLeaderboardUGC__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_SteamCore_OnAvailableBeaconLocationsDelegate__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_SteamCore_OnChangeNumOpenSlotsCallback__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_SteamCore_OnChangeNumOpenSlots__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_SteamCore_OnChangeNumOpenSlotsDelegate__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_SteamCore_OnCheckFileSignature__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_SteamCore_OnClientGameServerDeny__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_SteamCore_OnComputeNewPlayerCompatibility__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_SteamCore_OnCreateBeaconCallback__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_SteamCore_OnCreateBeacon__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_SteamCore_OnCreateBeaconDelegate__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_SteamCore_OnCreateItemAsyncDelegate__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_SteamCore_OnCreateItem__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_SteamCore_OnCreateLobbyAsyncDelegate__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_SteamCore_OnDeleteItemResultAsyncDelegate__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_SteamCore_OnDeleteItemResult__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_SteamCore_OnDownloadClanActivityCountsAsyncDelegate__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_SteamCore_OnDownloadItem__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_SteamCore_OnDownloadItemResult__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_SteamCore_OnDownloadItemResultDelegate__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_SteamCore_OnDownloadLeaderboardEntriesAsyncDelegate__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_SteamCore_OnDownloadLeaderboardEntries__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_SteamCore_OnDownloadLeaderboardEntriesForUsersAsyncDelegate__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_SteamCore_OnDownloadLeaderboardEntriesForUsers__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_SteamCore_OnEnumerateFollowingListAsyncDelegate__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_SteamCore_OnFailure__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_SteamCore_OnFileDetailsResultAsyncDelegate__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_SteamCore_OnFileReadAsync__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_SteamCore_OnFileShareAsync__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_SteamCore_OnFileWriteAsync__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_SteamCore_OnFindLeaderboardAsyncDelegate__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_SteamCore_OnFindLeaderboard__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_SteamCore_OnFindOrCreateLeaderboardAsyncDelegate__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_SteamCore_OnFindOrCreateLeaderboard__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_SteamCore_OnFindSessions__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_SteamCore_OnGamepadTextInputDismissed__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_SteamCore_OnGameWebCallback__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_SteamCore_OnGetAppDependenciesResultAsyncDelegate__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_SteamCore_OnGetAppDependenciesResult__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_SteamCore_OnGetAuthSessionTicketResponse__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_SteamCore_OnGetFollowerCountAsyncDelegate__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_SteamCore_OnGetNumberOfCurrentPlayersAsyncDelegate__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_SteamCore_OnGetNumberOfCurrentPlayers__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_SteamCore_OnGetOPFSettingsResult__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_SteamCore_OnGetUserItemVoteAsyncDelegate__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_SteamCore_OnGetUserItemVote__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_SteamCore_OnGetVideoURLResult__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_SteamCore_OnGSClientApprove__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_SteamCore_OnGSClientDeny__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_SteamCore_OnGSClientGroupStatus__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_SteamCore_OnGSPolicyResponse__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_SteamCore_OnGSValidateAuthTicketResponse__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_SteamCore_OnHTTPResponse__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_SteamCore_OnIPCFailure__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_SteamCore_OnIPCountry__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_SteamCore_OnIsFollowingAsyncDelegate__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_SteamCore_OnItemInstalled__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_SteamCore_OnJoinClanChatRoomAsyncDelegate__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_SteamCore_OnJoinLobbyAsyncDelegate__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_SteamCore_OnJoinPartyCallback__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_SteamCore_OnJoinParty__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_SteamCore_OnJoinPartyDelegate__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_SteamCore_OnLicensesUpdated__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_SteamCore_OnLowBatteryPower__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_SteamCore_OnMicroTxnAuthorizationResponse__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_SteamCore_OnPingServerAsyncDelegate__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_SteamCore_OnRemoteStoragePublishedFileSubscribed__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_SteamCore_OnRemoteStoragePublishedFileUnsubscribed__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_SteamCore_OnRemoteStorageSubscribePublishedFileResult__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_SteamCore_OnRemoteStorageUnsubscribePublishedFileResult__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_SteamCore_OnRemoveAppDependencyResultAsyncDelegate__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_SteamCore_OnRemoveAppDependencyResult__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_SteamCore_OnRemoveItemFromFavoritesAsyncDelegate__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_SteamCore_OnRemoveItemFromFavorites__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_SteamCore_OnRemoveUGCDependencyResultAsyncDelegate__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_SteamCore_OnRemoveUGCDependencyResult__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_SteamCore_OnRequestClanOfficerListAsyncDelegate__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_SteamCore_OnRequestEligiblePromoItemDefinitionsIDsAsyncDelegate__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_SteamCore_OnRequestEncryptedAppTicket__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_SteamCore_OnRequestEncryptedAppTicketResponse__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_SteamCore_OnRequestFriendRichPresence__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_SteamCore_OnRequestGlobalAchievementPercentagesAsyncDelegate__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_SteamCore_OnRequestGlobalAchievementPercentages__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_SteamCore_OnRequestGlobalStatsAsyncDelegate__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_SteamCore_OnRequestGlobalStats__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_SteamCore_OnRequestLobbyListAsyncDelegate__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_SteamCore_OnRequestUserInformationAsyncDelegate__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_SteamCore_OnRequestUserStatsAsyncDelegate__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_SteamCore_OnRequestUserStats__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_SteamCore_OnReservationNotificationDelegate__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_SteamCore_OnScreenshotReady__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_SteamCore_OnScreenshotRequested__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_SteamCore_OnSendQueryUGCRequestAsyncDelegate__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_SteamCore_OnSendQueryUGCRequest__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_SteamCore_OnServerRefreshCompleted__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_SteamCore_OnServerRefreshCompleteDelegate__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_SteamCore_OnServerRuleAsyncDelegate__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_SteamCore_OnServerUpdatedAsyncDelegate__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_SteamCore_OnSetPersonaNameAsyncDelegate__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_SteamCore_OnSetUserItemVoteAsyncDelegate__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_SteamCore_OnSetUserItemVote__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_SteamCore_OnStartPlaytimeTrackingAsyncDelegate__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_SteamCore_OnStartPlaytimeTracking__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_SteamCore_OnSteamInventoryRequestPricesResultAsyncDelegate__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_SteamCore_OnSteamInventoryStartPurchaseResultAsyncDelegate__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_SteamCore_OnSteamMessage__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_SteamCore_OnSteamRemotePlaySessionConnected__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_SteamCore_OnSteamRemotePlaySessionDisconnected__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_SteamCore_OnSteamServerConnectFailure__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_SteamCore_OnSteamServersConnected__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_SteamCore_OnSteamServersDisconnected__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_SteamCore_OnSteamShutdown__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_SteamCore_OnStopPlaytimeTrackingAsyncDelegate__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_SteamCore_OnStopPlaytimeTracking__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_SteamCore_OnStopPlaytimeTrackingForAllItemsAsyncDelegate__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_SteamCore_OnStopPlaytimeTrackingForAllItems__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_SteamCore_OnStoreAuthURLResponse__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_SteamCore_OnSubmitItemUpdateAsyncDelegate__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_SteamCore_OnSubmitItemUpdate__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_SteamCore_OnSubscribeItemAsyncDelegate__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_SteamCore_OnSubscribeItem__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_SteamCore_OnUGCDownloadAsync__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_SteamCore_OnUGCDownloadToLocationAsync__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_SteamCore_OnUnsubscribeItemAsyncDelegate__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_SteamCore_OnUnsubscribeItem__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_SteamCore_OnUploadLeaderboardScoreAsyncDelegate__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_SteamCore_OnUploadLeaderboardScore__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_SteamCore_OnUserAchievementIconFetched__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_SteamCore_OnUserAchievementStored__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_SteamCore_OnUserStatsReceived__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_SteamCore_OnUserStatsStored__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_SteamCore_OnUserStatsUnloaded__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_SteamCore_OnValidateAuthTicketResponse__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_SteamCore_RequestEncryptedAppTicketDelegate__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_SteamCore_RequestPlayersForGameFinalResultDelegate__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_SteamCore_RequestPlayersForGameProgressDelegate__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_SteamCore_RequestPlayersForGameResultDelegate__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_SteamCore_RequestStoreAuthURLDelegate__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_SteamCore_SearchForGameProgressDelegate__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_SteamCore_SearchForGameResultDelegate__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_SteamCore_SubmitPlayerResultResultDelegate__DelegateSignature,
			};
