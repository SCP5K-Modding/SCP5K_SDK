...
void EmptyLinkFunctionForGeneratedCodeDiscordAchievement_init() {}
	...
	UPackage* Z_Construct_UPackage__Script_DiscordAchievement()
	{
		...
		if (!ReturnPackage)
		{
			static UObject* (*const SingletonFuncArray[])() = {
				(UObject* (*)())Z_Construct_UDelegateFunction_DiscordAchievement_AchievementOnUserAchievementUpdate__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_DiscordAchievement_DiscordResultEvent__DelegateSignature,
			};
			static const UE4CodeGen_Private::FPackageParams PackageParams = {
				"/Script/DiscordAchievement",
				SingletonFuncArray,
