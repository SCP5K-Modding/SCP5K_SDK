...
void EmptyLinkFunctionForGeneratedCodeDiscordStore_init() {}
	...
	UPackage* Z_Construct_UPackage__Script_DiscordStore()
	{
		...
		if (!ReturnPackage)
		{
			static UObject* (*const SingletonFuncArray[])() = {
				(UObject* (*)())Z_Construct_UDelegateFunction_DiscordStore_OnStoreResultEvent__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_DiscordStore_DiscordEntitlementEvent__DelegateSignature,
			};
