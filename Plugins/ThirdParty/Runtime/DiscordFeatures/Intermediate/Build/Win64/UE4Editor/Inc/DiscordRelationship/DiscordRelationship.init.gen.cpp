...
void EmptyLinkFunctionForGeneratedCodeDiscordRelationship_init() {}
	...
	UPackage* Z_Construct_UPackage__Script_DiscordRelationship()
	{
		...
		if (!ReturnPackage)
		{
			static UObject* (*const SingletonFuncArray[])() = {
				(UObject* (*)())Z_Construct_UDelegateFunction_DiscordRelationship_DiscordFilterFunction__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_DiscordRelationship_OnRelationshipRefreshed__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_DiscordRelationship_OnRelationshipUpdate__DelegateSignature,
			};
			static const UE4CodeGen_Private::FPackageParams PackageParams = {
				"/Script/DiscordRelationship",
				SingletonFuncArray,
