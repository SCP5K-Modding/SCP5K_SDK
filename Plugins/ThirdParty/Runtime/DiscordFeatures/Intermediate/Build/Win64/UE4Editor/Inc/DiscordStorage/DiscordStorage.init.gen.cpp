...
void EmptyLinkFunctionForGeneratedCodeDiscordStorage_init() {}
	...
	UPackage* Z_Construct_UPackage__Script_DiscordStorage()
	{
		...
		if (!ReturnPackage)
		{
			static UObject* (*const SingletonFuncArray[])() = {
				(UObject* (*)())Z_Construct_UDelegateFunction_DiscordStorage_OnReadAsyncEvent__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_DiscordStorage_OnWriteAsyncEvent__DelegateSignature,
			};
			static const UE4CodeGen_Private::FPackageParams PackageParams = {
				"/Script/DiscordStorage",
				SingletonFuncArray,
