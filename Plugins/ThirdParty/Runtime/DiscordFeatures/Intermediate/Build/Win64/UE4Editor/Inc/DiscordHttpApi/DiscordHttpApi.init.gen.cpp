...
void EmptyLinkFunctionForGeneratedCodeDiscordHttpApi_init() {}
	...
	UPackage* Z_Construct_UPackage__Script_DiscordHttpApi()
	{
		...
		if (!ReturnPackage)
		{
			static UObject* (*const SingletonFuncArray[])() = {
				(UObject* (*)())Z_Construct_UDelegateFunction_DiscordHttpApi_OnWebhookCreated__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_DiscordHttpApi_DiscordWebhookEvent__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_DiscordHttpApi_OnGetWebhooks__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_DiscordHttpApi_OnGetWebhook__DelegateSignature,
			};
			static const UE4CodeGen_Private::FPackageParams PackageParams = {
				"/Script/DiscordHttpApi",
				SingletonFuncArray,
