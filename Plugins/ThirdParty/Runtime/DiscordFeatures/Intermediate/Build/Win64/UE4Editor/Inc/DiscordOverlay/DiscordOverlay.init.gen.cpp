...
void EmptyLinkFunctionForGeneratedCodeDiscordOverlay_init() {}
	...
	UPackage* Z_Construct_UPackage__Script_DiscordOverlay()
	{
		...
		if (!ReturnPackage)
		{
			static UObject* (*const SingletonFuncArray[])() = {
				(UObject* (*)())Z_Construct_UDelegateFunction_DiscordOverlay_OverlayResult__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_DiscordOverlay_DiscordOverlayToggleEvent__DelegateSignature,
			};
			static const UE4CodeGen_Private::FPackageParams PackageParams = {
				"/Script/DiscordOverlay",
				SingletonFuncArray,
