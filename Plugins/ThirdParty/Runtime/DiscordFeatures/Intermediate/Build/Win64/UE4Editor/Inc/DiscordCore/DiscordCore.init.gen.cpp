...
void EmptyLinkFunctionForGeneratedCodeDiscordCore_init() {}
	...
	UPackage* Z_Construct_UPackage__Script_DiscordCore()
	{
		...
		if (!ReturnPackage)
		{
			static UObject* (*const SingletonFuncArray[])() = {
				(UObject* (*)())Z_Construct_UDelegateFunction_DiscordCore_DiscordLogEvent__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_DiscordCore_OnRunCallbacks__DelegateSignature,
			};
